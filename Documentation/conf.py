...
copyright = u"""Copyright (c) 2014-2019 National Technology and Engineering Solutions of Sandia, LLC. Under the terms of Contract DE-NA0003525 with National Technology and Engineering Solutions of Sandia, LLC, the U.S. Government retains certain rights in this software."""
...
latex_documents = [
  ('index', 'Tracktable.tex', u'Tracktable Documentation',
   u'Andy Wilson and Danny Rintoul and Chris Valicka and Ben Newton and Phil Baxley', 'manual'),
]
...
man_pages = [
    ('index', 'tracktable', u'Tracktable 1.2.0 Documentation',
     [u'Andy Wilson and Danny Rintoul and Chris Valicka and Ben Newton and Phil Baxley and Kat Ward'], 1)
]
...
texinfo_documents = [
  ('index', 'Tracktable', u'Tracktable 1.2.0 Documentation',
   u'Andy Wilson and Danny Rintoul and Chris Valicka and Ben Newton and Phil Baxley and Kat Ward', 'Tracktable', 'Trajectory analysis and rendering.',
   'Miscellaneous'),
]
...
epub_author = u'Andy Wilson and Danny Rintoul and Chris Valicka and Ben Newton and Phil Baxley'
epub_publisher = u'Sandia National Laboratories'
epub_copyright = u'2014-2019, National Technology and Engineering Solutions of Sandia, Inc.'
