...
inFile = open('../../examples/data/SampleFlightsUS.csv')
...
render_trajectories(trajs[3], backend="folium", show=False, save=True, filename="../../../../../TestData/GroundTruth/Single.html")
...
render_trajectories(trajs[3], tiles='http://server.arcgisonline.com/ArcGIS/rest/services/NatGeo_World_Map/MapServer/tile/{z}/{y}/{x}', attr='ESRI', backend="folium", show=False, save=True, filename="../../../../../TestData/GroundTruth/TileServer.html")
...
render_trajectories(trajs, obj_ids="VVV022", backend="folium", show=False, save=True, filename="../../../../../TestData/GroundTruth/ObjIds.html")


# ... or a list of strings
render_trajectories(trajs, obj_ids=["JJJ010", "LLL012"], backend="folium", show=False, save=True, filename="../../../../../TestData/GroundTruth/ObjIdsList.html")
...
render_trajectories([trajs[0], trajs[12]], color_map = ['BrBG', 'plasma'], backend="folium", show=False, save=True, filename="../../../../../TestData/GroundTruth/ColormapMulti.html")
...
render_trajectories([trajs[0], trajs[12]], gradient_hue = [.25, .66], backend="folium", show=False, save=True, filename="../../../../../TestData/GroundTruth/GradientHueMulti.html")


# Hues can be derived from an rgb color specified as a color name or hex string color
render_trajectories([trajs[0], trajs[12]], gradient_hue = ['#00FF00', 'orange'], backend="folium", show=False, save=True, filename="../../../../../TestData/GroundTruth/GradientHueFromColors.html")
...
render_trajectories(trajs[26], linewidth=5, backend="folium", show=False, save=True, filename="../../../../../TestData/GroundTruth/Linewidth.html")
...
render_trajectories(trajs[15], show_points=True, point_popup_properties = ['altitude', 'heading', 'speed'], backend="folium", show=False, save=True, filename="../../../../../TestData/GroundTruth/PointProperties.html")
# Clicking on a point now additionaly reveals the altitude, heading, and speed.


# The colors of all points can be specified
render_trajectories(trajs[15], point_color='red', show_points=True, backend="folium", show=False, save=True, filename="../../../../../TestData/GroundTruth/PointSingleColor.html")


# The color and radius of the dot at the close of the trajectory can be changed
render_trajectories(trajs[24], dot_color='red', dot_size=5, backend="folium", show=False, save=True, filename="../../../../../TestData/GroundTruth/DotColorSize.html")


# To not show the dot at the close of the trajectory:
render_trajectories(trajs[24], show_dot=False, backend="folium", show=False, save=True, filename="../../../../../TestData/GroundTruth/NoDot.html")


# In folium the distance geometry calculations can be shown.  Default depth is 4
render_trajectories(trajs[25], show_distance_geometry=True, distance_geometry_depth=4, backend="folium", show=False, save=True, filename="../../../../../TestData/GroundTruth/DistanceGeometry.html")
